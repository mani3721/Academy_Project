...
const DayTimelineDemo=({ events, openside, currentDate })=>{
    ...
    return (
        <div className=" border-2 w-full border-red-600 px-5">
          ...
          {hours.map((hour) => (
          <div key={hour} className="flex px-5 py-10 font-poppins justify-between">
            <div className="text-[#525b68] font-Tinos " >{tConv24(hour)}</div>
          <div className="flex  justify-around w-[80%] border-2  border-green-700">
          <div>
          <EventList
