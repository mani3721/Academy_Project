...
const Addbatch = () => {
  ...
  const handleChange=(e)=>{
     setData({...data,[e.target.name]: e.target.value, students:studentsList})
  }
  ...
  const handleSubmit= async(e)=>{
     ...
     let allDates = getDatesBetween(new Date(data.start_date), new Date (data.end_date));
        ...
        <div className="bg-[#f2f2f4] flex justify-center w-screen h-screen items-center">
          <div className="bg-white py-5 rounded-xl shadow-lg flex-col gap-10 flex justify-center items-center w-[80%] h-[90vh]">
            ...
            <div className="flex justify-between p-3 w-[73%] items-center gap-4">
              ...
              <button onClick={handleSubmit} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-4 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
